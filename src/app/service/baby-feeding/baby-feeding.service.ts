...
export class BabyFeedingService {
    babyFeeding:any = [
        ...
        new BabyFeedingItem(0, {hour: 12, minutes: 12}, {hour: 12, minutes: 14}, 'bottle feeding', new Date('2016-07-28')),
        new BabyFeedingItem(0, {hour: 14, minutes: 12}, {hour: 14, minutes: 14}, 'bottle feeding', new Date('2016-07-28')),
        new BabyFeedingItem(0, {hour: 14, minutes: 12}, {hour: 14, minutes: 14}, 'bottle feeding', new Date('2016-07-30'))
    ];
